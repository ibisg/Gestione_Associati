$PBExportHeader$w_ricerca_struttura.srw
forward
global type w_ricerca_struttura from w_centered
end type
type cb_annulla from commandbutton within w_ricerca_struttura
end type
type sle_struttura from singlelineedit within w_ricerca_struttura
end type
type dw_current from datawindow within w_ricerca_struttura
end type
end forward
...
global w_ricerca_struttura w_ricerca_struttura
...
on w_ricerca_struttura.destroy
call super::destroy
...
ls_struttura= this.getItemString(this.getRow(), "vc_parent")+"."+this.getItemString(this.getRow(), "codice")
