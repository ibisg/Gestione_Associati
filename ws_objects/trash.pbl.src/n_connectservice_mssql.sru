$PBExportHeader$n_connectservice_mssql.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_connectservice_mssql from nonvisualobject
end type
end forward

global type n_connectservice_mssql from nonvisualobject
end type
global n_connectservice_mssql n_connectservice_mssql
...
on n_connectservice_mssql.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_connectservice_mssql.destroy
