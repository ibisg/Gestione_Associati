$PBExportHeader$w_liste_invio_tab_blat.srw
forward
global type w_liste_invio_tab_blat from window
end type
type tab_send from tab within w_liste_invio_tab_blat
end type
...
type gb_2 from groupbox within w_liste_invio_tab_blat
end type
type gb_5 from groupbox within w_liste_invio_tab_blat
end type
type gb_6 from groupbox within w_liste_invio_tab_blat
end type
type gb_7 from groupbox within w_liste_invio_tab_blat
end type
end forward
...
global w_liste_invio_tab_blat w_liste_invio_tab_blat
...
on w_liste_invio_tab_blat.create
...
on w_liste_invio_tab_blat.destroy
