$PBExportHeader$uotv_struttura_new.sru
forward
global type uotv_struttura_new from treeview
end type
end forward
...
string picturename[] = {"wi0064-48.gif","foot_orange.gif","foot_blue.gif","foot_red.gif","foot_yellow.gif","foot_green.gif","foot_orange.gif","CharlieBrown2.gif","lucy_32x32.jpg","Linus.gif","Sally.gif","0.gif","bullet_square_yellow.gif",""}
...
global uotv_struttura_new uotv_struttura_new
...
if s_struttura_root_s.livello < is_tvinit_s.ai_maxlivello then
	...
	ls_query=	"select struttura.livello, vc_nodo, relazione, vc_parent, codice, struttura_livelli.descrizione, struttura.descrizione, struttura.flag_attiva "+&
	...
	if trap_sql(sqlca, "RUNQUERYNODI") < 0 then return -1
		...
		do while sqlca.sqlcode <> 100
			...
			fetch  nodi_cur
			into :s_struttura_child_s.livello, :s_struttura_child_s.vc_nodo, :s_struttura_child_s.relazione, : s_struttura_child_s.vc_parent, :s_struttura_child_s.codice,  :s_struttura_child_s.descrizione_livello, :s_struttura_child_s.descrizione_struttura, :s_struttura_child_s.flag_attiva;
...
on uotv_struttura_new.create
end on

on uotv_struttura_new.destroy
end on
