$PBExportHeader$w_ricercapercomuni_new.srw
forward
global type w_ricercapercomuni_new from window
end type
type ddlb_filtro from dropdownlistbox within w_ricercapercomuni_new
end type
type st_3 from statictext within w_ricercapercomuni_new
end type
type ddlb_localita from dropdownlistbox within w_ricercapercomuni_new
end type
type cb_dom from commandbutton within w_ricercapercomuni_new
end type
type sle_filtro from singlelineedit within w_ricercapercomuni_new
end type
type pb_ordina from picturebutton within w_ricercapercomuni_new
end type
type sle_struttura from singlelineedit within w_ricercapercomuni_new
end type
type st_2 from statictext within w_ricercapercomuni_new
end type
type st_1 from statictext within w_ricercapercomuni_new
end type
type pb_go from picturebutton within w_ricercapercomuni_new
end type
type cbx_resp from checkbox within w_ricercapercomuni_new
end type
type ddlb_provincia from dropdownlistbox within w_ricercapercomuni_new
end type
type ddlb_regione from dropdownlistbox within w_ricercapercomuni_new
end type
type gb_criteri from groupbox within w_ricercapercomuni_new
end type
type gb_filtro from groupbox within w_ricercapercomuni_new
end type
type dw_current from datawindow within w_ricercapercomuni_new
end type
type uodw_tv_ricerca from uodw_generica within w_ricercapercomuni_new
end type
end forward
...
uodw_tv_ricerca uodw_tv_ricerca
end type
global w_ricercapercomuni_new w_ricercapercomuni_new
...
on w_ricercapercomuni_new.create
...
this.uodw_tv_ricerca=create uodw_tv_ricerca
...
this.gb_filtro,&
this.dw_current,&
this.uodw_tv_ricerca}
end on

on w_ricercapercomuni_new.destroy
...
event collapsed;call super::collapsed;	is_comune= ""
	pb_ordina.enabled= false
end event

event doubleclicked;call super::doubleclicked;string ls_codice
s_ricercanominativa s_ricercanominativa_s
...
event expanded;call super::expanded;	is_comune= this.getItemString(row, "comune")
	pb_ordina.enabled= true
end event
