$PBExportHeader$w-ricerca_tv.srw
forward
global type w-ricerca_tv from w_generica_sheet
end type
type mdi_1 from mdiclient within w-ricerca_tv
end type
end forward
...
global w-ricerca_tv w-ricerca_tv

on w-ricerca_tv.create
int iCurrent
call super::create
...
on w-ricerca_tv.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.mdi_1)
end on

type uodw_current from w_generica_sheet`uodw_current within w-ricerca_tv
