$PBExportHeader$w_liste_invio_tab_good18072018.srw
forward
global type w_liste_invio_tab_good18072018 from window
end type
type tab_send from tab within w_liste_invio_tab_good18072018
end type
...
type gb_2 from groupbox within w_liste_invio_tab_good18072018
end type
type gb_5 from groupbox within w_liste_invio_tab_good18072018
end type
type gb_6 from groupbox within w_liste_invio_tab_good18072018
end type
type gb_7 from groupbox within w_liste_invio_tab_good18072018
end type
end forward
...
global w_liste_invio_tab_good18072018 w_liste_invio_tab_good18072018
...
on w_liste_invio_tab_good18072018.create
...
on w_liste_invio_tab_good18072018.destroy
...
long ll_idx= 1, ll_tgt= 0, ll_found, ll_totrows, ll_totmail, ll_invio= 0, ll_modulo= 100
...
w_wait_meter.st_wait.text= "Generazione ed invio messaggi..."
	...
	do while sqlca.sqlcode <> 100
		...
		if sqlca.sqlcode= 100 then continue
			...
			if ll_tgt= ll_modulo OR ll_invio= ll_totmail then		
						...
						IF li_ret <> 0 THEN
							...
							choose case li_ret
								...
								case 1
									...
									MessageBox("Invio messaggi", "Messaggi non inviati. Verificare gli indirizzi dei destinatari")
									
								case 2
									
									MessageBox("Invio messaggi", "Messaggi non inviati. Verificare indirizzo e password del mittente")
