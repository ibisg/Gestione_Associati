$PBExportHeader$n_gestione_associati_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_gestione_associati_connectservice from nonvisualobject
end type
end forward

global type n_gestione_associati_connectservice from nonvisualobject
end type
global n_gestione_associati_connectservice n_gestione_associati_connectservice
...
on n_gestione_associati_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_gestione_associati_connectservice.destroy
