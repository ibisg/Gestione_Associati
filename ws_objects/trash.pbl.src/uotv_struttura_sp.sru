$PBExportHeader$uotv_struttura_sp.sru
forward
global type uotv_struttura_sp from treeview
end type
end forward
...
global uotv_struttura_sp uotv_struttura_sp
...
on uotv_struttura_sp.create
end on

on uotv_struttura_sp.destroy
end on
