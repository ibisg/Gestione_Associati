$PBExportHeader$w_liste_invio_tab_new.srw
forward
global type w_liste_invio_tab_new from window
end type
type tab_send from tab within w_liste_invio_tab_new
end type
...
type gb_2 from groupbox within w_liste_invio_tab_new
end type
type gb_5 from groupbox within w_liste_invio_tab_new
end type
type gb_6 from groupbox within w_liste_invio_tab_new
end type
type gb_7 from groupbox within w_liste_invio_tab_new
end type
end forward
...
global w_liste_invio_tab_new w_liste_invio_tab_new
...
on w_liste_invio_tab_new.create
...
on w_liste_invio_tab_new.destroy
...
w_wait_meter.st_wait.text= "Generazione ed invio messaggi..."
	...
	do while sqlca.sqlcode <> 100
		...
		ll_tgt++
				...
				w_wait_meter.hpb_meter.position= 100*(ll_tgt/ll_totmail)
				
				if ll_tgt= ll_modulo OR ll_tgt= ll_totmail then
					
						ls_sms_s.ai_maxnames= ll_modulo
