$PBExportHeader$uodw_anagrafica.sru
forward
global type uodw_anagrafica from datawindow
end type
end forward
...
global uodw_anagrafica uodw_anagrafica
...
on uodw_anagrafica.create
end on

on uodw_anagrafica.destroy
end on
