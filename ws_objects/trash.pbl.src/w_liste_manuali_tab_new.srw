$PBExportHeader$w_liste_manuali_tab_new.srw
forward
global type w_liste_manuali_tab_new from w_liste_invio_tab
end type
type rb_doc from radiobutton within w_liste_manuali_tab_new
end type
type pb_carica from commandbutton within w_liste_manuali_tab_new
end type
type gb_tipo from groupbox within w_liste_manuali_tab_new
end type
end forward
...
global w_liste_manuali_tab_new w_liste_manuali_tab_new

type variables
dataWindowChild dwc_cod_lista
string is_or
end variables
on w_liste_manuali_tab_new.create
int iCurrent
call super::create
...
on w_liste_manuali_tab_new.destroy
call super::destroy
destroy(this.rb_doc)
...
type tab_send from w_liste_invio_tab`tab_send within w_liste_manuali_tab_new
integer y = 280
integer width = 4027
integer height = 2672
end type
...
event dw_liste_mail::retrievestart;call super::retrievestart;return 2
end event

event dw_liste_mail::sqlpreview;call super::sqlpreview;string ls_newsyntax

//ls_newsyntax= sqlsyntax+w_liste_manuali_tab.is_or
this.SetSQLPreview(ls_newsyntax)
end event
...
event dw_liste_sms::retrievestart;call super::retrievestart;return 2 // append dei risultati delle query...
end event
...
type gb_2 from w_liste_invio_tab`gb_2 within w_liste_manuali_tab_new
end type

type gb_5 from w_liste_invio_tab`gb_5 within w_liste_manuali_tab_new
end type

type gb_6 from w_liste_invio_tab`gb_6 within w_liste_manuali_tab_new
end type

type gb_7 from w_liste_invio_tab`gb_7 within w_liste_manuali_tab_new
end type
...
event clicked;open(w_seleziona_lista_multipla)
