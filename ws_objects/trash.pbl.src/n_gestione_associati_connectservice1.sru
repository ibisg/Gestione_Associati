$PBExportHeader$n_gestione_associati_connectservice1.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_gestione_associati_connectservice1 from nonvisualobject
end type
end forward

global type n_gestione_associati_connectservice1 from nonvisualobject
end type
global n_gestione_associati_connectservice1 n_gestione_associati_connectservice1
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "C:\svil_11\Gestione_Associati\connection.ini"
		...
		as_server		= ProfileString ( ls_inifile, "Database", "Servername", "fitsrv2")
		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "Database='seg2ga',CommitOnDisconnect='No'")
	...
	Case IS_USE_REGISTRY						/*  Populate Database Connection from Registry  */
		...
		If RegistryGet ( ls_registrykey, "Servername", 	RegString!, as_server ) <> 1 Then
			RegistrySet ( ls_registrykey, "Servername", 	RegString!, "fitsrv2" )
			RegistryGet ( ls_registrykey, "Servername", 	RegString!, as_server )
		End If
		If RegistryGet ( ls_registrykey, "DBParm", 		RegString!, as_dbparm ) <> 1 Then
			RegistrySet ( ls_registrykey, "DBParm", 		RegString!, "Database='seg2ga',CommitOnDisconnect='No'" )
	...
	Case IS_USE_SCRIPT							/*  Populate Database Connection from Script  */
		...
		as_server		= "fitsrv2"
		as_dbparm		= "Database='seg2ga',CommitOnDisconnect='No'"
		as_lock			= ""
		as_autocommit	= "false"
...
on n_gestione_associati_connectservice1.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_gestione_associati_connectservice1.destroy
