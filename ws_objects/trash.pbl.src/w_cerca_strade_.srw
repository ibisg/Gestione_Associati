$PBExportHeader$w_cerca_strade_.srw
forward
global type w_cerca_strade_ from w_centered
end type
type cb_annulla from commandbutton within w_cerca_strade_
end type
type dw_current from datawindow within w_cerca_strade_
end type
type mle_warning from multilineedit within w_cerca_strade_
end type
type cb_selcap from commandbutton within w_cerca_strade_
end type
type cb_seltutto from commandbutton within w_cerca_strade_
end type
type cb_query from commandbutton within w_cerca_strade_
end type
type st_1 from statictext within w_cerca_strade_
end type
end forward
...
global w_cerca_strade_ w_cerca_strade_
