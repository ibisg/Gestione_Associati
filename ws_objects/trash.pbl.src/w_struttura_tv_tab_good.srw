$PBExportHeader$w_struttura_tv_tab_good.srw
forward
global type w_struttura_tv_tab_good from w_struttura_tv
end type
type tab_dettaglio from tab within w_struttura_tv_tab_good
end type
...
type cb_ricercaanomalie from commandbutton within w_struttura_tv_tab_good
end type
type shl_altritipi from statichyperlink within w_struttura_tv_tab_good
end type
end forward
...
global w_struttura_tv_tab_good w_struttura_tv_tab_good
...
on w_struttura_tv_tab_good.create
int iCurrent
call super::create
...
on w_struttura_tv_tab_good.destroy
call super::destroy
...
type phl_trova from w_struttura_tv`phl_trova within w_struttura_tv_tab_good
boolean map3dcolors = false
string powertiptext = "Esegue la ricerca per nome o struttura"
end type

type st_ricerca1 from w_struttura_tv`st_ricerca1 within w_struttura_tv_tab_good
integer width = 658
end type

type dw_cerca from w_struttura_tv`dw_cerca within w_struttura_tv_tab_good
integer taborder = 10
end type

type tv_struttura from w_struttura_tv`tv_struttura within w_struttura_tv_tab_good
...
//			DESTROY mSes
	...
	//SMS
			...
			li_ret= f_sendmail_pb(mMsg, s_sms_s)
...
//		 cod_studio ='04' and  string(data_esame, 'dd.mm.yyyy') = '25.08.2010'
