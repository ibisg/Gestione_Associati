$PBExportHeader$w_struttura_tv2.srw
forward
global type w_struttura_tv2 from window
end type
type st_3 from statictext within w_struttura_tv2
end type
type st_2 from statictext within w_struttura_tv2
end type
type st_1 from statictext within w_struttura_tv2
end type
type tv_dettaglio from treeview within w_struttura_tv2
end type
type dw_scheda from datawindow within w_struttura_tv2
end type
type tv_struttura from treeview within w_struttura_tv2
end type
end forward
...
global w_struttura_tv2 w_struttura_tv2
