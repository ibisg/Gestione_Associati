...
type st_4 from statictext within w_conteggio
end type
type ddlb_livello from dropdownlistbox within w_conteggio
end type
type pb_struttura from picturebutton within w_conteggio
end type
type cb_start from commandbutton within w_conteggio
end type
type st_3 from statictext within w_conteggio
end type
type st_2 from statictext within w_conteggio
end type
type st_1 from statictext within w_conteggio
end type
type em_struttura from editmask within w_conteggio
end type
type em_ultimoesame from editmask within w_conteggio
end type
type em_datasoglia from editmask within w_conteggio
end type
type uodw_current from uodw_generica within w_conteggio
end type
type gb_1 from groupbox within w_conteggio
end type
type gb_2 from groupbox within w_conteggio
end type
end forward
...
event resize;
uodw_current.height=this.height - uodw_current.y - 120
end event
...
fontfamily fontfamily = swiss!
string facename = "Tahoma"
string text = "Esegui l~'estrazione"
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Soglia data cerimonia"
alignment alignment = right!
boolean focusrectangle = false
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Inserisci i criteri di partecipazione"
end type
