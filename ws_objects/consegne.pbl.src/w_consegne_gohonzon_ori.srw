$PBExportHeader$w_consegne_gohonzon_ori.srw
forward
global type w_consegne_gohonzon_ori from window
end type
type dw_header from uodw_header within w_consegne_gohonzon_ori
end type
type tab_gohonzon from tab within w_consegne_gohonzon_ori
end type
...
type s_cons from structure within w_consegne_gohonzon_ori
end type
end forward
...
global w_consegne_gohonzon_ori w_consegne_gohonzon_ori
...
for ll_count = 1 to tab_gohonzon.tabpage_inserimento.uodw_import.RowCount ()
	...
	if tab_gohonzon.tabpage_inserimento.uodw_import.GetItemString ( ll_count, "flag_ok" ) = "1" then
		...
		ds_lista.SetItem ( ll_row, "flag_ok", "1" )
...
tab_gohonzon.tabpage_inserimento.cb_estrazione.enabled= true
tab_gohonzon.tabpage_inserimento.pb_struttura.enabled= true
tab_gohonzon.tabpage_inserimento.uodw_import.Object.DataWindow.queryMode= 'Yes'

return 0
end event

on w_consegne_gohonzon_ori.create
...
on w_consegne_gohonzon_ori.destroy
